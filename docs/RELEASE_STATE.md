...
| 项 | 值 | 怎么核 |
| --- | --- | --- |
| 应用代码版本 | `0755e09`（2026-08-30 03:2x UTC 上线；此前依次 `ec2d1b5` → `08ad898` → `263d0bd` → `7a80c9e`） | `scripts/verify_deployed_tree.py --manifest <清单> --revision 0755e09` 应输出 `MATCH … identical=89`（2026-08-30 03:55 UTC 实测通过） |
| 部署树后续同步 | 已与 `main` 一致 | `git diff 0755e09..main -- app web alembic` 应为空 |
...
**无。生产 = `0755e09` = origin/main 的最新提交（2026-08-30 03:5x UTC 上线）。**
