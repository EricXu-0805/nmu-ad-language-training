...
> **最新上线（2026-08-23 11:04–11:22 UTC）**：`92040ac` → **`edb363d`**，**零迁移热更新**
...
| 项 | 值 | 怎么核 |
| --- | --- | --- |
| 应用代码版本 | `edb363d`（2026-08-23 11:22 UTC 上线；此前 `92040ac`/`7d70cce` 08-21 热更、`3ccb86d` 08-20） | `scripts/verify_deployed_tree.py --manifest <清单> --revision edb363d` 应输出 `MATCH … identical=89`（2026-08-23 11:2x 实测通过） |
